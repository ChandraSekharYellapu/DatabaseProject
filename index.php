...
<body>
	...
	<!-- Faceback left part -->
		...
		<!--Left part-->
		<!--Mobile Image--> 	
	<div style="position:absolute; left:5%; top:35%;"> </div>
    <div style="position:absolute; left:7%; top:24%; color:#3B5998; font-size:28px;"> <font face="myFbFont"> Friendbook helps you connect and share with </font> </div>
